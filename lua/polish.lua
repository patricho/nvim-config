...
-- Barbar tabline
vim.api.nvim_set_hl(0, 'BufferCurrent', { fg = '#ffffff', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferCurrentMod', { fg = '#ffffff', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferCurrentADDED', { fg = '#238636', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferCurrentCHANGED', { fg = '#bd561d', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferCurrentDELETED', { fg = '#da3633', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferCurrentERROR', { fg = '#d72222', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferCurrentSign', { fg = '#333333', bg = '#333333' })
vim.api.nvim_set_hl(0, 'BufferInactiveSign', { fg = '#333333', bg = 'NONE' })
