  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        ["<Leader>e"] = { function() Snacks.explorer.reveal() end, desc = "Toggle Snacks explorer" },
        ["<Leader>E"] = { function() Snacks.explorer({ layout = { preset = "sidebar", preview = false, layout = { position = "right", width = 0.333 }}}) end, desc = "Toggle Snacks explorer (sidebar)" },
        ["<Leader>ss"] = { function() Snacks.picker() end, desc = "Snacks pickers" },
        ["<Leader>sf"] = { function() Snacks.picker("files") end, desc = "Snacks files picker" },
        ["<Leader>sg"] = { function() Snacks.picker("grep") end, desc = "Snacks grep picker" },
        ["<Leader>su"] = { function() Snacks.picker("undo") end, desc = "Snacks undo picker" },
        ["<Leader>sb"] = { function() Snacks.picker("grep_buffers") end, desc = "Snacks grep buffers picker" },
        ...
        ["<Leader>glm"] = { "<cmd>GitLink default_branch<cr>", desc = "Yank git link (main)" },
        ["<Leader>glc"] = { "<cmd>GitLink current_branch<cr>", desc = "Yank git link (current branch)" },
        ["<Leader>gdw"] = { "<cmd>CodeDiff<cr>", desc = "CodeDiff: Diff current working folder" },
        ["<Leader>gdb"] = { "<cmd>CodeDiff file HEAD<cr>", desc = "CodeDiff: Diff current buffer" },
        ["<Leader>gdm"] = { "<cmd>CodeDiff main<cr>", desc = "CodeDiff: Diff current branch against main" },
